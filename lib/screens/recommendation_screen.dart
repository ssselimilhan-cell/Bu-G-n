...
```
  _companions.remove(CompanionType.any);
...
```
  _budgets.remove(BudgetType.any);
...
```
  _durations.remove(DurationType.any);
...
```
  _interests.remove(InterestType.any);
...
return !start.isBefore(range.start) &&
